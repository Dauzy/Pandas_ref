...
spanishPlayers = pd.Series(['Casillas', 'Ramos', 'Pique', 'Puyol', 'Capdevila', 
	'Xabi Alonso', 'Busquets', 'Xavi Hernandez', 'Pedrito','Iniesta', 'Villa'])

print("Spanish players: \n%s" % spanishPlayers)
...
print("Spanish Players and team \n%s" %spanishPlayersDF)

frame1 = pd.read_csv('./data/movies/rated_movies.csv',header=0)
print("\n",frame1.ix[1])
print("\n",frame1.columns)
print("\n",frame1.index)